import { getNewsByCategoryId, getNewsDetailsById } from "@/app/lib/data";
...
const NewsDetailsPage = async ({ params }) => {
  ...
  const singleNews = await getNewsDetailsById(id);
      ...
      <div className="card bg-base-100 shadow-sm">
        <div className="card-body">
          ...
          <div>
            ...
            <Link href={`/category/${singleNews.category_id}`}>
              <button className="btn">See Others News</button>
            </Link>
          </div>
        </div>
      </div>
